...
const Accommodation = () => {
    ...
    const featureIcons = {
        "Private Terrace/Patio": <FaUmbrellaBeach className="w-4 h-4 text-[#009ee2] mr-1"/>,
        "Hot Water": <Droplets className="w-4 h-4 text-[#009ee2] mr-1"/>,
        "03 Twin Beds": <IoBedOutline className="w-4 h-4 text-[#009ee2] mr-1"/>,
        "04 twin Beds": <IoBedOutline className="w-4 h-4 text-[#009ee2] mr-1"/>,
        "Large King Size Bed": <IoBedOutline className="w-4 h-4 text-[#009ee2] mr-1"/>,
        "Air Conditioning": <Wind className="w-4 h-4 text-[#009ee2] mr-1"/>,
        "Tea/Coffee Makers": <Coffee className="w-4 h-4 text-[#009ee2] mr-1"/>,
        "In Room Safe": <Shield className="w-4 h-4 text-[#009ee2] mr-1"/>,
        "Wi-Fi": <Wifi className="w-4 h-4 text-[#009ee2] mr-1"/>
    };
                ...
                <div className="py-16">
                    ...
                    >
                        <div className="text-center">
                            ...
                            <motion.p
                                className="text-lg text-[#5f6b8c] max-w-4xl mx-auto"
                                variants={heroTextVariants}
                            >
                            ...
                            >
                                <div className="flex flex-col md:flex-row">
                                    ...
                                    <div className="relative md:w-1/3 overflow-hidden">
                                        ...
                                        />
                                        <motion.div
                                            className="absolute top-3 right-3 bg-[#009ee2] text-white px-3 py-1 rounded-full text-sm font-medium"
                                    ...
                                    >
                                        <div className="flex flex-col md:flex-row md:justify-between md:items-start">
                                            ...
                                            >
                                                <span className="text-[#009ee2] font-semibold">{room.room} Rooms</span>
                                            </motion.div>
                                        </div>
                                        <motion.span
                                            className="text-md font-bold text-[#cc9933] block"
                                            initial={{ opacity: 0 }}
                                            whileInView={{ opacity: 1 }}
                                            viewport={{ once: true }}
                                        ...
                                        >
                                            <motion.a
                                                ...
                                                className={'flex-1 bg-[#0c1f4f] hover:bg-[#5f6b8c] text-white text-center font-semibold py-2 px-2 rounded-lg transition-colors duration-200'}
                                            ...
                                            <motion.button
                                                ...
                                                className="flex-1 bg-[#009ee2] hover:bg-[#b4e4f8] hover:text-[#0c1f4f] text-white font-semibold py-2 px-2 rounded-lg transition-colors duration-200"
                                                whileHover={{ scale: 1.05 }}
                                                whileTap={{ scale: 0.95 }}
                                            >
                                            ...
                                            <motion.button
                                                ...
                                                className="flex-1 bg-[#cc9933] hover:bg-[#c6bba9] text-white font-semibold py-2 px-2 rounded-lg transition-colors duration-200"
                                                whileHover={{ scale: 1.05 }}
                                                whileTap={{ scale: 0.95 }}
                                            >
                                        ...
                                        {expandedRoom === index && (
                                            ...
                                            >
                                                                ...
                                                                >
                                                                    ...
                                                                    >
                                                                        {featureIcons[feature] ||
                                                                            <div className="w-1 h-1 bg-[#009ee2] rounded-full mr-2"></div>}
                                                                    </motion.span>
                                                                    {feature}
                                                                </motion.li>
                                                            ))}
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            {room.amenities.map((amenity, idx) => (
                                                                ...
                                                                >
                                                                    <motion.div
                                                                        className="w-1 h-1 bg-[#009ee2] rounded-full mr-2"
                                                                        whileHover={{ scale: 2 }}
                                                                        transition={{ duration: 0.2 }}
                                                                    ></motion.div>
                                                                    {amenity}
                                                ...
                                                <motion.div
                                                    ...
                                                    transition={{ duration: 0.4, delay: 0.3 }}
                                                >
                                                    <h4 className="font-semibold text-gray-800 mb-2">Other Facilities:</h4>
                                                    <div className="text-sm text-gray-600 mb-4">
                                                        {Object.entries(room.otherFacilities).slice(0, 8).map(([category, details], idx) => (
                                                            ...
                                                            >
                                                                <div className="font-medium text-[#009ee2]">
                                                                    {category}
                                                                </div>
                                                    ...
                                                    <motion.div
                                                        className="bg-[#e3f2f8] p-3 rounded-lg mt-2"
                                                    ...
                                                    >
                                                        <p className="text-sm text-[#0c1f4f] font-medium">Direct Rate: {room.rates.directRate}</p>
